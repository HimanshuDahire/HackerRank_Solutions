...
Explanation 0 : There are 5 students in this class whose names and grades are assembled to build the following list:
...
sc = [i[1] for i in records]
sc = [i for i in sc if i != min(sc)]
